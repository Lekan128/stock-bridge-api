 ...
 *
 * <h2>sku is null when the tenant auto-generates it</h2>
 * {@code sku} is null exactly when {@code ProductExcelService.parse} was called with {@code
 * skuAutoGenerated=true} - any cell value present in the file was deliberately never read, not
 * merely allowed to be blank. {@code ProductCatalogRowHandler.commit} fills in the real generated
 * value later, per row, in file order - see {@code SkuGenerationService.generateAndReserveBlock}.
 */
