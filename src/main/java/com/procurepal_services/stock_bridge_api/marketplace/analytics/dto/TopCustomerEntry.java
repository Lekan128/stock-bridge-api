...
/**
 * One row of the top-customers ranking. Mixes in-window figures with all-time ones on
 * purpose: "spent ₦2m this quarter" and "has spent ₦40m since 2024" answer different
 * questions, and an operator deciding who to call needs both on the same line.
 *
 ...
 *     ignoring the window entirely. Note this differs from the customers list's
